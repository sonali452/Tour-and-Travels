		...
		<div class="wpte-trip-category-overlay">
			...
			if ( $show_view_more_button ) :
				...
				<div class="wpte-trip-category-btn">
					<a href="<?php echo esc_url( $term_object->link ); ?>" class="wpte-trip-cat-btn"><?php echo ! empty( $attributes->{'linkText'} ) ? esc_html( $attributes->{'linkText'} ) : __( 'View All', 'wp-travel-engine' ); ?></a>
				</div>
			<?php endif; ?>
		</div>
	</div>
