...
?>
<div class="wpte-field wpte-text wpte-floated">
	<label class="wpte-field-label" data-wte-update="wte_new_430" for="wp_travel_engine_settings[email][booking_notification_subject_customer]"><?php _e( 'Booking Email Subject', 'wp-travel-engine' ); ?></label>
...
<div class="wpte-field wpte-textarea wpte-floated">
	<label class="wpte-field-label" data-wte-update="wte_new_430" for="booking_notification_template_customer"><?php _e( 'Booking Notification', 'wp-travel-engine' ); ?></label>
		<?php
		...
		<span class="wpte-tooltip"><?php esc_html_e( 'This template will be used when a booking request has been made by the customer.', 'wp-travel-engine' ); ?> <a class="wte-email-template-preview-link" href="<?php echo home_url( '/' ); ?>?_action=email-template-preview&template_type=order&pid=0&to=customer"><?php esc_html_e( 'Preview Template', 'wp-travel-engine' ); ?></a></span>
...
<div class="wpte-field wpte-textarea wpte-floated">
	<label class="wpte-field-label" data-wte-update="wte_updated_430" for="purchase_wpeditor"><?php _e( 'Purchase Receipt', 'wp-travel-engine' ); ?></label>
		<?php
