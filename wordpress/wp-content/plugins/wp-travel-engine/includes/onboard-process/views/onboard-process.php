						...
						<div class="wpte-block-content">
							<div class="wpte-field wpte-checkbox advance-checkbox">
								...
								<div class="wpte-checkbox-wrap">
									...
									<?php
									echo checked( $disable_admin_notification, '1' );
									?>
							...
							<div class="wpte-field wpte-text wpte-floated">
								...
								value="
								<?php
								if ( isset( $wp_travel_engine_tabs['email']['from'] ) && $wp_travel_engine_tabs['email']['from'] != '' ) {
									echo esc_attr( $wp_travel_engine_tabs['email']['from'] );
								} else {
