	...
	<div class="wpte-block-content">
		<ul class="wpte-list">
			...
			<li>
				...
				<span><?php echo wte_get_formated_price_html( $total_paid ); ?></span>
			</li>
			<li>
				<b><?php _e( 'Remaining Payment', 'wp-travel-engine' ); ?></b>
				<span><?php echo wte_get_formated_price_html( $remaining_payment ); ?></span>
			</li>
			<li>
				<b><?php _e( 'Total Cost', 'wp-travel-engine' ); ?></b>
				<span><?php echo wte_get_formated_price_html( $total_cost ); ?></span>
			</li>
			<!-- <li>
	...
	<div class="wpte-block-content">
		<ul>
			...
			<li>
				...
				<span>
					<?php echo wte_get_formated_price_html( $discount['actual_total'] ); ?>
				</span>
			</li>
			<li>
