    ...
    <div class="wpte-bf-book-summary">
                    ...
                    <table class="wpte-bf-extra-info-table">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="wpte-remain-amt"><b><?php echo wte_get_formated_price_html( ( $cart_totals['sub_total'] - $cart_totals['total_partial'] ), null, true ); ?></b></td>
                            </tr>
                        </tbody>
                    </table>
                <?php endif; ?>
        ...
        ?>
            <div class="wpte-bf-total-price">
                ...
                <span class="wpte-price"><?php echo wte_get_formated_price_html( $payable_now, null, true ); ?>
                </span>
            </div>
