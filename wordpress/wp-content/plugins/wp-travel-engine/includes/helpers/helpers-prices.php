...
function wp_travel_engine_is_trip_partially_payable( $trip_id ) {
	...
	$trip_partial_payment_enabled = isset( $wte_trip_metas['partial_payment_enable'] ) && 'yes' === $wte_trip_metas['partial_payment_enable'];
	$global_partial_pay_enable    = isset( $wte_options['partial_payment_enable'] ) && 'yes' === $wte_options['partial_payment_enable'];
