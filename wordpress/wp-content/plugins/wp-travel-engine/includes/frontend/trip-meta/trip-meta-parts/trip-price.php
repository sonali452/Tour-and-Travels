		...
		<?php if ( ! isset( $wte_options['show_multiple_pricing_list_disp'] ) || '1' != $wte_options['show_multiple_pricing_list_disp'] ) { ?>
			<div class="wpte-bf-price">
				<?php if ( $is_sale_price_enabled ) : ?>
					<del>
						<?php echo wte_get_formated_price_html( $regular_price ); ?>
					</del>
				<?php endif; ?>
				<ins>
					<?php echo wte_get_formated_price_html( $price ); ?></b>
				</ins>
				<?php
			...
			<div class="wpte-bf-step-content-wrap">
				...
				<div class="wte-bf-price-detail" style="display: none">
					<div class="wpte-bf-total-price">
						...
						<?php echo wte_get_formated_price_html( $price ); ?>
					</div>
					<div class="wpte-bf-toggle-wrap wpte-bf-animate-toggle">
						...
						<div class="wpte-bf-toggle-content">
							...
							<table class="wpte-bf-travellers-price-table">
								...
								<tbody>
									<tr>
										<td>1 <?php echo apply_filters( 'wte_default_traveller_type', __( 'Person', 'wp-travel-engine' ) ); ?> <span class="wpte-bf-info">(<?php echo wte_get_formated_price( $price ); ?>/<?php echo apply_filters( 'wte_default_traveller_type', __( 'Person', 'wp-travel-engine' ) ); ?>)</span></td>
										<td><?php echo wte_get_formated_price_html( $price ); ?></td>
									</tr>
								</tbody>
							</table>
							<?php do_action( 'wte_before_trip_price_total' ); ?>
							<div class="wpte-bf-total">
								<?php _e( 'Total', 'wp-travel-engine' ); ?>: <b><?php echo wte_get_formated_price_html( $price ); ?></b>
							</div>
