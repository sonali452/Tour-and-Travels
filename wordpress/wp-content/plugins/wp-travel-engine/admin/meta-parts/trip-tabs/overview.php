...
<div class="wpte-form-block-wrap">
	<div class="wpte-form-block">
		<div class="wpte-title-wrap">
			<h2 class="wpte-title"><?php _e( 'Trip Description', 'wp-travel-engine' ); ?></h2>
		</div>
		<div class="wpte-form-content">
			<div class="wpte-field wpte-text wpte-floated">
				...
				<span class="wpte-tooltip"><?php _e( 'Enter the overview section title', 'wp-travel-engine' ); ?></span>
			</div>

			<div class="wpte-field wpte-textarea wpte-floated wpte-rich-textarea delay">
				<label class="wpte-field-label"><?php _e( 'Trip Description', 'wp-travel-engine' ); ?></label>
				<!-- <div class="wte-editor-notice">
						<?php _e( 'Click to initialize RichEditor', 'wp-travel-engine' ); ?>
					</div> -->
				<textarea placeholder="<?php _e( 'Trip Overview:', 'wp-travel-engine' ); ?>"
				...
				<span class="wpte-tooltip"><?php _e( 'The overview section content', 'wp-travel-engine' ); ?></span>
			</div>
		</div>
	</div> <!-- .wpte-form-block -->
	<div class="wpte-form-block">
		<div class="wpte-title-wrap">
			<h2 class="wpte-title"><?php _e( 'Trip Highlights', 'wp-travel-engine' ); ?></h2>
		</div>
		<div class="wpte-form-content">
			<div class="wpte-field wpte-text wpte-floated">
				<label class="wpte-field-label"><?php _e( 'Section Title', 'wp-travel-engine' ); ?></label>
				...
				<span
					class="wpte-tooltip"><?php _e( 'Enter title for the Trip Highlights section.', 'wp-travel-engine' ); ?></span>
			</div>
...
<div class="wpte-field wpte-submit">
	<input data-tab="overview" data-post-id="<?php echo esc_attr( $post_id ); ?>"
		data-nonce="<?php echo esc_attr( wp_create_nonce( 'wpte-trip-tab-save-continue' ) ); ?>"
		...
		value="<?php _e( 'Save &amp; Continue', 'wp-travel-engine' ); ?>">
</div>
	<?php
endif;
