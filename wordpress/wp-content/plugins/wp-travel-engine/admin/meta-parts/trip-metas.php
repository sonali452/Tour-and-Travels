...
$trip_meta_tabs = array(
	'wpte-general'               => array(
		'tab_label'         => __( 'General', 'wp-travel-engine' ),
		'tab_heading'       => __( 'General', 'wp-travel-engine' ),
	...
	'wpte-pricing'               => array(
		'tab_label'         => __( 'Pricing', 'wp-travel-engine' ),
		'tab_heading'       => __( 'Pricing', 'wp-travel-engine' ),
	...
	'wpte-overview'              => array(
		'tab_label'         => __( 'Overview', 'wp-travel-engine' ),
		'tab_heading'       => __( 'Overview', 'wp-travel-engine' ),
	...
	'wpte-itinerary'             => array(
		'tab_label'         => __( 'Itinerary', 'wp-travel-engine' ),
		'tab_heading'       => __( 'Itinerary', 'wp-travel-engine' ),
	...
	// ),
	'wpte-facts'                 => array(
		'tab_label'         => __( 'Trip Info', 'wp-travel-engine' ),
		'tab_heading'       => __( 'Trip Info', 'wp-travel-engine' ),
	...
	'wpte-gallery'               => array(
		'tab_label'         => __( 'Gallery', 'wp-travel-engine' ),
		'tab_heading'       => __( 'Gallery', 'wp-travel-engine' ),
	...
	'wpte-map'                   => array(
		'tab_label'         => __( 'Map', 'wp-travel-engine' ),
		'tab_heading'       => __( 'Map', 'wp-travel-engine' ),
