	...
	<div class="wpte-bf-summary-wrap">
		...
		foreach ( $cart_items as $key => $cart_item ) :
			...
			<div class="wpte-bf-trip-name-wrap">
				...
				// echo esc_html(
				// 	sprintf(
				// 		__( 'Starting Date: %1$s ' . '[' . wp_timezone()->getName() . ']', 'wp-travel-engine' ),
				// 		wp_date( $date_format, strtotime( $trip_date ) )
				// 	)
				// );
				?>
					</span>
				...
				<tfoot>
					<tr>
						<td colspan="2">
							...
							<?php echo wte_get_formated_price_html( $cart_totals['sub_total'], null, true ); ?>
						</td>
					</tr>
				...
				<table class="wpte-bf-extra-info-table">
					<tbody>
						<tr>
							...
							<td class="wpte-dwnpay-amt"><b><?php echo wte_get_formated_price_html( $cart_totals['total_partial'], null, true ); ?></b></td>
						</tr>
						<tr>
						<td><span><?php esc_html_e( 'Remaining Payment', 'wp-travel-engine' ); ?></span></td>
							...
							if ( ( ! empty( $cart_discounts ) || sizeof( $cart_discounts ) !== 0 ) ) {
								...
								echo wte_get_formated_price_html( $partial_final_total, null, true );
							} else {
	...
	?>
		<div class="wpte-bf-total-price">
			...
			<span class="wpte-price">
				<?php echo wte_get_formated_price_html( $payable_now, null, true ); ?>
			</span>
		</div>
