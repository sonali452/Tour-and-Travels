...
#>
	...
	<div class="wte-booking-summary-info">
		...
		printf( __( 'Package: %s', 'wp-travel-engine' ), '{{{tripPackages[ selectedPackage ].title.rendered}}}' );
		?>
		</h5>
		<#
		} // endiftpsp;
		...
		<div class="wte-booking-trip-info">
			...
			<div class="wte-booking-details">
				...
				<ul>
					...
					#>
					<li>
						<label><strong>{{count}} {{packageCategories[cid].label}}</strong> <span class="qty">({{{formatPrice(price)}}}/{{pc.pricingType === 'per-group' ? "<?php _e( 'group', 'wp-travel-engine' ); ?>" : "<?php _e( 'person', 'wp-travel-engine' ); ?>"}})</span></label>
