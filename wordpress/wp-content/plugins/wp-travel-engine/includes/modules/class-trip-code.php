	...
	public static function trip_code_setion() {
		...
		?>
			<div class="wpte-field wpte-trip-code wpte-floated">
				<label for="wp_travel_engine_setting[trip_code]" class="wpte-field-label"><?php _e( 'Trip Code', 'wp-travel-engine' ); ?></label>
				<span class="wpte-trip-code-box">
					<input type="text" id="wp_travel_engine_setting[trip_code]" name="wp_travel_engine_setting[trip_code]" value="<?php echo $trip_code ? esc_attr( $trip_code ) : esc_html( sprintf( __( 'WTE-%1$s', 'wp-travel-engine' ), $post->ID ) ); ?>" placeholder="<?php _e( 'Enter Trip Code', 'wp-travel-engine' ); ?>">
				</span>
