...
<div class = "wpte-bf-checkout">
	<table class="wpte-lrf-tables">
		<tr>
			<th><span class="wpte-bf-trip-name"><?php echo $order_trip->title; ?></span></th>
			<td>
			...
			<td>
				...
				<span class="lrf-td-desc"><?php echo wte_get_formated_price_html( $booking_object->cart_info['total'] ); ?></span>
			</td>
			<td>
				<span class="lrf-td-title"><?php _e( 'Paid', 'wp-travel-engine' ); ?></span>
				<span class="lrf-td-desc"><?php echo wte_get_formated_price_html( $total_paid ); ?></span>
			</td>
			<td>
				<span class="lrf-td-title"><?php _e( 'Due', 'wp-travel-engine' ); ?></span>
				<span class="lrf-td-desc"><?php echo wte_get_formated_price_html( $due ); ?></span>
			</td>
		</tr>
	</table>
