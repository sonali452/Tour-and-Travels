...
<div class="wp-block-wptravelengine wpte-gblock-wrapper">
	...
	?>
	<div class="<?php printf( 'wte-d-flex wte-layout-grid wte-col-%1$d wpte-trip-list-wrapper columns-%1$d %2$s', $attributes->{'itemsPerRow'}, ( $attributes->{'cardlayout'} === 2 ) ? 'full-width' : '' ); ?>">
		<?php
	...
	<?php if ( wte_array_get( (array) $attributes, 'layoutFilters.showViewAll', false ) ) : ?>
		<div class="wte-block-btn-wrapper">
			<a href="<?php echo esc_url( trailingslashit( $view_all_link ) ); ?>" class="wte-view-all-trips-btn"><?php echo wte_array_get( (array) $attributes, 'viewAllButtonText', __( 'View All', 'wp-travel-engine' ) ); ?></a>
		</div>
		<?php
	endif;
	?>
