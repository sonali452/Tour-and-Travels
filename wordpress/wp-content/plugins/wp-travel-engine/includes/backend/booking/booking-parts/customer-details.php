...
$billing_info = is_array( $booking->billing_info ) ? $booking->billing_info : array();
...
<div class="wpte-block wpte-col3">
	<div class="wpte-title-wrap">
		<h4 class="wpte-title"><?php _e( 'Billing Details', 'wp-travel-engine' ); ?></h4>
...
<div class="wpte-block wpte-col3">
	<div class="wpte-title-wrap">
		<h4 class="wpte-title"><?php _e( 'Customer Details', 'wp-travel-engine' ); ?></h4>
	...
	<div class="wpte-block-content">
		<ul class="wpte-list">
			<?php if ( isset( $booking_metas['place_order']['booking'] ) ) : ?>
				<li>
					<b><?php _e( 'Customer ID', 'wp-travel-engine' ); ?></b>
					<?php
