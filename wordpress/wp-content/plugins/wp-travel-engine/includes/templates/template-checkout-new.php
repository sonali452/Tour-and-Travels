				...
				<div class="wpte-bf-checkout-form">
					...
					class="">
						...
						<div class="wpte-bf-field wpte-bf-submit">
							<input type="submit" data-checkout-label="<?php echo esc_attr__( 'Pay %s', 'wp-travel-engine' ); ?>" name="wp_travel_engine_nw_bkg_submit"  value="<?php esc_attr_e( 'Book Now', 'wp-travel-engine' ); ?>">
						</div>
