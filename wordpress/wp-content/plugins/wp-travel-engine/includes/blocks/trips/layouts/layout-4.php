...
<div class="wpte-trip-single">
	<div class="wpte-trip-image-wrap">
		...
		<div class="discount-text-wrap">
			<span class="discount-percent"><?php echo sprintf( __( '%1$s%% Off', 'wp-travel-engine' ), $meta->discount_percent ); ?></span>
		</div>
		<?php endif; ?>
		...
		<div class="featured-text-wrap">
			...
			<span class="featured-text"><?php _e( 'Featured', 'wp-travel-engine' ); ?></span>
		</div>
		<?php endif; ?>
		...
		<div class="wpte-trip-meta-list">
			...
			<span class="wpte-trip-meta wpte-trip-duration">
				...
				if ( ! empty( $meta->duration['days'] ) ) :
					printf( _n( '%d Day', '%d Days', $meta->duration['days'], 'wp-travel-engine' ), $meta->duration['days'] );
				endif;
			...
			<span class="wpte-trip-meta wpte-trip-pax">
				...
				<?php printf( __( '%s People', 'wp-travel-engine' ), (int) $meta->max_pax ? $meta->min_pax . '-' . $meta->max_pax : $meta->min_pax ); ?>
			</span>
			<?php endif; ?>
		</div>
		<div class="wpte-trip-budget-wrap justify-content-between align-items-center">
			...
			<div class="wpte-trip-price-wrap">
				<?php if ( wte_array_get( $settings, 'layoutFilters.showStrikedPrice', true ) && $meta->has_sale ) : ?>
					<del><?php echo wte_get_formated_price_html( $meta->price ); ?></del>
				<?php endif; ?>
				<ins><?php echo wte_get_formated_price_html( $meta->has_sale ? $meta->sale_price : $meta->price ); ?></ins>
			</div>
			<?php endif; ?>
			<?php if ( wte_array_get( $settings, 'layoutFilters.showViewMoreButton', true ) ) : ?>
			<div class="wpte-trip-btn-wrap">
				<a href="<?php echo esc_url( get_the_permalink( $trip->ID ) ); ?>" class="wpte-trip-explore-btn"><?php echo wte_array_get( $settings, 'viewMoreButtonText', __( 'View Details', 'wp-travel-engine' ) ); ?></a>
			</div>
			<?php endif; ?>
		</div>
	</div>
