		...
		foreach ( $categories_in_package as $c_id ) {
			...
			<div class="wpte-bf-price">
				<span class="wpte-bf-reg-price">
					<span class="wpte-bf-price-from"><?php _e( 'From', 'wp-travel-engine' ); ?></span>
					<?php if ( $has_sale ) : ?>
						<del><?php echo \wte_get_formated_price( $price ); ?></del>
					<?php endif; ?>
				</span>
				<span class="wpte-bf-offer-price">
					<ins class="wpte-bf-offer-amount"><?php echo \wte_get_formated_price( $sale_price ); ?></ins>
					<div class="wpte-bf-pqty"><?php printf( esc_html__( 'per %s', 'wp-travel-engine' ), $per_label ); ?></div>
				</span>
			</div>
			<?php
		}
