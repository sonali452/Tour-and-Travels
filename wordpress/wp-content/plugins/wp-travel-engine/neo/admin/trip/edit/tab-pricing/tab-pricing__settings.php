...
<div class="wpte-field wpte-onoff-block">
	...
	>
		...
		><?php esc_html_e( 'Hide Fixed Trip Starts Dates section', 'wp-travel-engine' ); ?><span class="wpte-onoff-btn"></span></label>
	</a>
	<input
		type="checkbox"
		...
		data-parsley-id="58"
	>
	<span class="wpte-tooltip"><?php esc_html_e( 'Check this if you want to disable fixed trip starting dates section between featured image/slider and trip
		content sections.', 'wp-travel-engine' ); ?></span>
</div>
<div class="wpte-shortcode">
	<span class="wpte-tooltip"><?php echo wp_kses( sprintf( __('To display fixed starting dates in page/post use the following %sShortcode.%s', 'wp-travel-engine' ), '<b>', '</b>' ), ['b' => []]); ?></span>
...
<div class="wpte-shortcode">
	<span class="wpte-tooltip"><?php echo wp_kses( sprintf( __('To display fixed starting dates in theme/template, please use below %sPHP Funtion.%s', 'wp-travel-engine' ), '<b>', '</b>' ), ['b' => []]); ?></span>
	<div class="wpte-field wpte-field-gray wpte-floated">
